                            ...
                            <tbody class="divide-y divide-gray-100 bg-white">
                                ...
                                <tr class="userRow">
                                    <td class="px-6 py-4 flex items-center gap-3">
                                        ...
                                        <div>
                                            <p class="font-semibold">Rohit Jain</p>
                                            <p class="text-xs text-gray-400">#U0001</p>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-6 py-4">Mar 12, 2024</td>
                                    <td class="px-6 py-4"><span
                                ...
                                <tr class="userRow">
                                    <td class="px-6 py-4 flex items-center gap-3">
                                        <img src="https://i.pravatar.cc/100?img=5" alt=""
                                            class="w-10 h-10 rounded-full" />
                                        <div>
                                            <p class="font-semibold">ujjwal Jain</p>
                                            <p class="text-xs text-gray-400">#U0001</p>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">rohit@example.com</td>
                                    <td class="px-6 py-4"><span
                                            class="bg-indigo-100 text-indigo-700 text-xs px-2 py-1 rounded">Seller</span>
                                    </td>
                                    <td class="px-6 py-4">Mar 12, 2024</td>
                                    <td class="px-6 py-4"><span
                                            class="bg-green-100 text-green-700 text-xs px-2 py-1 rounded">Active</span>
                                ...
                                <tr class="userRow">
                                    <td class="px-6 py-4 flex items-center gap-3">
                                        <img src="https://i.pravatar.cc/100?img=5" alt=""
                                            class="w-10 h-10 rounded-full" />
                                        <div>
                                            <p class="font-semibold">Ankur Jain</p>
                                            <p class="text-xs text-gray-400">#U0001</p>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">rohit@example.com</td>
                                    <td class="px-6 py-4"><span
                                            class="bg-indigo-100 text-indigo-700 text-xs px-2 py-1 rounded">User</span>
                                    </td>
                                    <td class="px-6 py-4">Mar 12, 2024</td>
                                    <td class="px-6 py-4"><span
                                            class="bg-green-100 text-green-700 text-xs px-2 py-1 rounded">Active</span>
